...
system("cls");//Clear screen
//Level-2 display
cout<<"\t\t\tSTUDENT MANAGEMENT SECTION\n\n\n";
cout<<"Enter your choice: "<<endl;
...
if((choice=='y')||(choice=='Y')||(choice=='1'))
{
 ...
 f1<<studentData.fname<<endl<<studentData.lname<<endl<<studentData.Registration<<endl<<studentData.classes<<endl<<studentData.grade<<endl;
...
if(studentData.fname==find)
{
 ...
 cout<<"Course: "<<studentData.classes<<endl;
...
cout<<"\t\t\tTEACHERS INFORMATION SECTION\n\n\n";
cout<<"Enter your choice: "<<endl;
cout<<"1.Create new entry\n";
